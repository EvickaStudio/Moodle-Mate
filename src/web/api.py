...
class WebUI:
    def __init__(self, settings: Settings, state_manager: StateManager, app_instance: Any):
    ...
    def _setup_routes(self):
        ...
        @self.app.post("/api/test-notification", dependencies=[Depends(self._auth_dependency)])
