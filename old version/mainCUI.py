...
# Initialize start time at the beginning of your script
start_time = datetime.now()


# Set up logging to file
logging.basicConfig(
    filename="moodle_mate.log",
    level=logging.INFO,
...
COLOR_HEADER = "\033[38;5;231m"
COLOR_STATUS = "\033[38;5;14m"
COLOR_SETTINGS = "\033[38;5;137m"
COLOR_ABOUT = "\033[38;5;2m"
COLOR_TEXT = "\033[38;5;240m"
COLOR_CONSOLE = "\033[38;5;140m"
COLOR_INFO = "\033[38;5;250m"
COLOR_BORDER = "\033[38;5;240m"
COLOR_MOODLE = "\033[38;5;9m"
COLOR_EVICKA = "\033[38;5;17m"
COLOR_MATE = "\033[38;5;240m"
...
def main_loop(handler, summarizer, sender, sleep_duration=60, max_retries=3):
    ...
    retry_count = 0
    while True:
        print(get_status(moodle_handler, summarizer, sender))
        try:
...
def get_status(moodle_handler, summarizer, sender):
    ...
    Status = "running"
    moodle_url = moodle_handler.api.config["moodle"]["moodleUrl"]
    discord_state = "Enabled" if sender.webhook_state == 1 else "Disabled"
    pushbullet_state = "Enabled" if sender.pushbullet_state == 1 else "Disabled"
    gpt_model = moodle_handler.api.config["moodle"]["model"]
    version = "0.3.2"  # Placeholder for actual version
    last_message = "15:00:00"  # Placeholder for actual last message
    request_count = 0
    ...
    return f"""{COLOR_BORDER}╭─┐ {RESET}Moodle Mate {COLOR_BORDER}┌────────────────────────────────────────────────────────╮
│       {COLOR_MOODLE}__  ___             ____    {COLOR_MATE}__  ___     __{COLOR_HEADER}        {RESET},-------,      {COLOR_BORDER}│
│      {COLOR_MOODLE}/  |/  /__  ___  ___/ / /__ {COLOR_MATE}/  |/  /__ _/ /____{COLOR_HEADER}   {RESET}/       / |     {COLOR_BORDER}│
│     {COLOR_MOODLE}/ /|_/ / _ \/ _ \/ _  / / -_){COLOR_MATE} /|_/ / _ `/ __/ -_){COLOR_HEADER} {RESET}/______ /  /     {COLOR_BORDER}│
│    {COLOR_MOODLE}/_/  /_/\___/\___/\_,_/_/\__/{COLOR_MATE}_/  /_/\_,_/\__/\__/{COLOR_HEADER} {RESET}|___/___/  /      {COLOR_BORDER}│
│     -—--–=¤=—--–-- - -  {COLOR_EVICKA}EvickaStudio{COLOR_BORDER}  - - --–--—=¤=--{RESET}|__{COLOR_BORDER}..{RESET}___|.'{COLOR_BORDER}- -    │
│                                                        //              {COLOR_BORDER}│
{COLOR_STATUS}╭─┐ {RESET}Status{COLOR_STATUS} ┌──────────────╮{COLOR_SETTINGS}╭─┐ {RESET}Settings{COLOR_SETTINGS} ┌────────────────────────────────╮
{COLOR_STATUS}├ {COLOR_TEXT}Status: {COLOR_INFO}{Status:>15}{RESET} {COLOR_STATUS}│{COLOR_SETTINGS}├ {COLOR_TEXT}Username: {COLOR_INFO}{username:>33} {COLOR_SETTINGS}│
{COLOR_STATUS}├ {COLOR_TEXT}Requests: {COLOR_INFO}{request_count:>13}{RESET} {COLOR_STATUS}│{COLOR_SETTINGS}├ {COLOR_TEXT}Moodle URL: {COLOR_INFO}{moodle_url:>31} {COLOR_SETTINGS}│
{COLOR_STATUS}├ {COLOR_TEXT}Uptime: {COLOR_INFO}{formatted_uptime:>15}{RESET} {COLOR_STATUS}│{COLOR_SETTINGS}├ {COLOR_TEXT}Dicord State: {COLOR_INFO}{discord_state:>29} {COLOR_SETTINGS}│
{COLOR_STATUS}├ {COLOR_TEXT}Last Message: {COLOR_INFO}{last_message:>9}{RESET} {COLOR_STATUS}│{COLOR_SETTINGS}├ {COLOR_TEXT}Pushbullet State: {COLOR_INFO}{pushbullet_state:>25} {COLOR_SETTINGS}│
{COLOR_ABOUT}╭─┐ {RESET}About{COLOR_ABOUT} ┌───────────────╮{COLOR_SETTINGS}├ {COLOR_TEXT}GPT Model: {COLOR_INFO}{gpt_model:>32} {COLOR_SETTINGS}│
{COLOR_ABOUT}├ {COLOR_TEXT}Moodle-Mate: {COLOR_INFO}{version:>10}{RESET} {COLOR_ABOUT}│{COLOR_CONSOLE}╭─┐ {RESET}Console{COLOR_CONSOLE} ┌─────────────────────────────────╮
{COLOR_ABOUT}├ {COLOR_TEXT}Author:    {COLOR_INFO}EvickaStudio{RESET} {COLOR_ABOUT}│{COLOR_CONSOLE}├ {COLOR_TEXT}Console:               {COLOR_INFO}Waiting for input...{RESET} {COLOR_CONSOLE}│
{COLOR_ABOUT}╰─────────────────────────╯{COLOR_CONSOLE}╰─────────────────────────────────────────────╯
{RESET}
"""
